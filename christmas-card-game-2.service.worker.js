...
const CACHE_NAME = "christmas-card-game-2-cache";
const OFFLINE_URL = "christmas-card-game-2.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["christmas-card-game-2.html","christmas-card-game-2.js","christmas-card-game-2.wasm","christmas-card-game-2.pck","christmas-card-game-2.offline.html","christmas-card-game-2.icon.png","christmas-card-game-2.apple-touch-icon.png"];
